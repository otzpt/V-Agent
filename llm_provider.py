...
def build_provider(cfg: dict, system_prompt: str = "") -> LLMProvider:
    ...
    if provider_name == "groq":
        ...
        return GroqProvider(key, cfg.get("groq_model", ALLOWED_GROQ_MODELS[0]), system_prompt)
    ...
    if provider_name == "openrouter":
        ...
        return OpenRouterProvider(key, cfg.get("openrouter_model", ALLOWED_OPENROUTER_FREE_MODELS[0]), system_prompt)
