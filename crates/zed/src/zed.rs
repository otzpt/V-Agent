...
fn initialize_panels(window: &mut Window, cx: &mut Context<Workspace>) -> Task<anyhow::Result<()>> {
    cx.spawn_in(window, async move |workspace_handle, cx| {
        ...
        // The collaboration panel is not loaded in V-Agent. Channels, project
        // sharing and voice require Zed Industries' RPC and LiveKit servers
        // plus a Zed account, none of which V-Agent has or can provide. The
        // panel would render a list of controls that cannot work.
