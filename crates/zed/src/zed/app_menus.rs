...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    let mut view_items = vec![
        ...
        // No "Collab Panel" entry: collaboration needs Zed's servers and a
        // Zed account, so the panel is not loaded in V-Agent.
    ...
    vec![
        Menu {
            ...
            disabled: false,
            items: vec![
                MenuItem::action("About V-Agent", zed_actions::About),
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide V-Agent", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit V-Agent", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            disabled: false,
            items: vec![
                // V-Agent one-click Build & Run of the active file (also F9 / Ctrl-F5).
                MenuItem::action(
                    "▶ Build & Run",
                    zed_actions::Spawn::ByName {
                        task_name: "▶ Build & Run".to_string(),
                        reveal_target: None,
                    },
                ),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                // These pointed at zed.dev docs, Zed's Twitter and Zed's jobs
                // page. A fork's Help menu should not send users to another
                // company's site, and certainly should not recruit for them.
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                        url: "https://github.com/otzpt/V-Agent#readme".into(),
                    },
                ),
                MenuItem::action("V-Agent Repository", feedback::OpenZedRepo),
                MenuItem::separator(),
                MenuItem::action(
                    "Upstream Project (V-Agent)",
                    super::OpenBrowser {
