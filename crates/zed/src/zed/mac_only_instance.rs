...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "V-Agent Editor Dev Instance Running",
        ReleaseChannel::Nightly => "V-Agent Editor Nightly Instance Running",
        ReleaseChannel::Preview => "V-Agent Editor Preview Instance Running",
        ReleaseChannel::Stable => "V-Agent Editor Stable Instance Running",
    }
}
