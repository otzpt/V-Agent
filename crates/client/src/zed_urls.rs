//! Contains helper functions for constructing URLs to various V-Agent-related pages.
//!
...
/// Returns the URL to V-Agent's terms of service.
pub fn terms_of_service(cx: &App) -> String {
    format!("{server_url}/terms-of-service", server_url = server_url(cx))
}

/// Returns the URL to V-Agent AI's privacy and security docs.
...
/// Returns the URL to V-Agent's edit prediction documentation.
...
/// Returns the URL to V-Agent's Agent sandboxing documentation.
///
...
/// Returns the URL to V-Agent's ACP registry blog post.
