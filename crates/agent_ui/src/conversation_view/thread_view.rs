...
impl ThreadView {
    ...
    fn run_local_command(
        ...
        match command {
            ...
            PromptLocalCommand::SwitchModel => {
                window.dispatch_action(ToggleModelSelector.boxed_clone(), cx);
            }
            PromptLocalCommand::ThinkingEffort => {
                window.dispatch_action(ToggleThinkingEffortMenu.boxed_clone(), cx);
            }
            PromptLocalCommand::ClearConversation => {
