...
pub enum PromptLocalCommand {
    ThumbsUp,
    ThumbsDown,
    /// V-Agent: open the model picker.
    SwitchModel,
    /// V-Agent: open the thinking-effort menu.
    ThinkingEffort,
    /// V-Agent: start a fresh conversation.
    ClearConversation,
}
...
impl PromptLocalCommand {
    pub fn keyword(&self) -> &'static str {
        match self {
            ...
            Self::ThinkingEffort => "effort",
            Self::ClearConversation => "clear",
        }
    }
    ...
    pub fn label(&self) -> &'static str {
        match self {
            ...
            Self::ClearConversation => "Clear Conversation",
        }
    }
    ...
    pub fn description(&self) -> &'static str {
        match self {
            ...
            Self::ClearConversation => "Start a fresh conversation",
        }
    }
    ...
    pub fn icon(&self) -> IconName {
        match self {
            ...
            Self::SwitchModel => IconName::Sparkle,
            Self::ThinkingEffort => IconName::Settings,
            Self::ClearConversation => IconName::Eraser,
        }
    }
}
