...
/// Inserts V-Agent-specific environment variables for terminal sessions.
...
impl Terminal {
    ...
    /// remote host, in case V-Agent is connected to a remote host.
    ...
    fn register_task_finished(
        ...
        if !lines_to_show.is_empty() {
            ...
            // when V-Agent task finishes and no more output is made.
