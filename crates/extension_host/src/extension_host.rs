...
/// The current extension [`SchemaVersion`] supported by V-Agent.
...
/// Returns the [`SchemaVersion`] range that is compatible with this version of V-Agent.
pub fn schema_version_range() -> RangeInclusive<SchemaVersion> {
    SchemaVersion::ZERO..=CURRENT_SCHEMA_VERSION
}

/// Returns whether the given extension version is compatible with this version of V-Agent.
...
impl ExtensionStore {
    ...
    /// Installs any extensions that should be included with V-Agent by default.
    ///
