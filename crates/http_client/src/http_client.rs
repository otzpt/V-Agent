...
impl HttpClientWithUrl {
    ...
    /// Builds a V-Agent API URL using the given path.
    ...
    /// Builds a V-Agent Cloud URL using the given path.
    ...
    /// Builds a V-Agent Cloud URL using the given path and query params.
    ...
    /// Builds a V-Agent LLM URL using the given path.
