---
title: Roc
description: "Configure Roc language support in V-Agent, including language servers, formatting, and debugging."
---
...
Roc language support in V-Agent is provided by the community-maintained [Roc extension](https://github.com/h2000/zed-roc).
