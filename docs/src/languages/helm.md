---
title: Helm
description: "Configure Helm language support in V-Agent, including language servers, formatting, and debugging."
---

# Helm

Support for Helm in V-Agent is provided by the community-maintained [Helm extension](https://github.com/cabrinha/helm.zed).
