---
title: Proto
description: "Configure Proto language support in V-Agent, including language servers, formatting, and debugging."
---
...
Or you can have zed directly invoke `clang-format` by specifying it as a [formatter](../reference/all-settings.md#formatter) in your settings:
