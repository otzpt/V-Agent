...
- Description: Controls whether V-Agent or the window manager or compositor draws window decorations.
- Setting: `window_decorations`
- Default: `"client"`

**Options**

1. To have V-Agent draw its own window decorations, use `"client"`:
...
> Note: This setting only affects Linux. GNOME Wayland does not support server-side decorations. Changes only apply to newly created windows. Restart V-Agent to apply the setting to all windows.
