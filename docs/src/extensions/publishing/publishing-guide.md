...
description: "Submit and update extensions in the V-Agent Extension Registry."
---
...
That's it! Once your PR is accepted and merged, the extension will be packaged and published to the V-Agent extension registry.
