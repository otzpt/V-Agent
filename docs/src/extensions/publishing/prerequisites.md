...
- Your extension must only include the resources it requires to function and nothing else.
  - See the [directory structure of a V-Agent extension](../developing-extensions.md#directory-structure-of-a-zed-extension) and the [Rust and WebAssembly](../developing-extensions.md#rust-and-webassembly) sections for more information.
