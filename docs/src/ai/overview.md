---
title: AI in V-Agent
description: Understand V-Agent's AI features, agent paths, model providers, and setup routes.
---
...
Model access controls which models power the V-Agent Agent and other model-backed V-Agent AI features. V-Agent can use hosted models, provider API access, subscription sign-in, gateways, and local models.

See [LLM Providers](./llm-providers.md) to choose a model access path.

## AI Features {#ai-features}

V-Agent has several AI-powered workflows:
...
For privacy, provider data boundaries, and opt-in data sharing, see [AI Privacy](./privacy-and-security.md) and Feedback and Training Data.
