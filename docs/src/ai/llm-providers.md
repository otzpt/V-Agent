---
title: LLM Providers - V-Agent
description: Choose how V-Agent gets language models: V-Agent-hosted models, API access, subscriptions, gateways, or local models.
---
...
[Edit Prediction](./edit-prediction.md) has its own provider setup under `edit_predictions`. LLM providers on this page apply to model-backed V-Agent AI features such as V-Agent Agent, Inline Assistant, Git commit generation, and thread summaries.
