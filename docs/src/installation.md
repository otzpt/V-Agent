...
[the Void Linux guide](./development/voidlinux.md) for building the
package yourself from `packaging/void/template`, and
[the roadmap](https://github.com/otzpt/V-Agent/blob/main/ROADMAP.md) for what is still outstanding.
