---
title: Icon Themes
description: "V-Agent comes with a built-in icon theme, with more icon themes available as extensions."
---

# Icon Themes

V-Agent comes with a built-in icon theme, with more icon themes available as extensions.
...
Just like with themes, V-Agent allows for configuring different icon themes for light and dark mode.
...
See: [Developing V-Agent Icon Themes](./extensions/icon-themes.md)
