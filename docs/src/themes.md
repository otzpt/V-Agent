---
title: Themes - V-Agent
description: Browse, install, and create themes for V-Agent. Includes built-in themes and community theme extensions.
---

# Themes

V-Agent comes with a number of built-in themes, with more themes available as extensions.
...
By default, V-Agent maintains two themes: one for light mode and one for dark mode.
