---
title: Release Notes
description: "Guide to release notes for V-Agent development."
---
...
- A `Release Notes` line should only be written if the user can see or feel the difference in V-Agent.
- A `Release Notes` line should be written such that a V-Agent user can understand what the change is.
